        ...
        try:
            if edit_message:
                ...
                if isinstance(edit_message, (str, int)):
                    ...
                    if current_text.strip() == clean_new_text and edit_message.reply_markup == keyboard:
                         return edit_message
            ...
            return await self.send_message(chat_id, text, keyboard, edit_message, link_preview, reply_id, parse_mode, attempt + 1)
            ...
            err_str = str(e).lower()
            if any(x in err_str for x in ['blocked', 'user is deactivated', 'chat not found', 'kicked']):
