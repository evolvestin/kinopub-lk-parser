...
urlpatterns = proxy_patterns + [
    ...
    path(
        'api/webapp/show/<int:show_id>/notification_status/',
        views.webapp_show_notification_status,
        name='webapp_show_notification_status',
    ),
    path(
        'api/webapp/toggle_mute_notification/',
        views.webapp_toggle_mute_notification,
        name='webapp_toggle_mute_notification',
    ),
    ...
    path('api/bot/unassign_group_view/', views.bot_unassign_group_view),
